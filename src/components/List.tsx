...
import { deleteTodo, removeTodoToBasket, toggleTodo } from '../slices/todosSlice';
...
export const List: React.FC<ListProps> = ({
	...
	return (
		<li
			className="flex justify-between items-center break-words overflow-clip text-ellipsis text-slate-100 gap-2 m-4 border border-slate-300 rounded-tr-2xl rounded-bl-2xl p-5"
			key={todo.id}
		>
			<p
